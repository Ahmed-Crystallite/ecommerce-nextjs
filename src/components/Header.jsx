        ...
        <header className="relative">
            <div className="container">
                <div className="py-4 gap-5 flex items-center justify-between">
                    ...
                    <ul className={`md:flex justify-center grid grid-cols-1 md:static absolute transition-all duration-500 ease-in-out md:translate-y-0 md:bg-transparent md:p-0 z-10 gap-5 font-semibold ${!openIndex ? "-translate-y-full" : "translate-y-0 bg-black/80 right-0 text-white py-4 px-4 md:top-0 top-14 rounded-xl"}`}>
                        {
                            [
                    ...
                    <button className="relative z-50 md:hidden block w-10" onClick={() => setOpenIndex((prev) => (!prev))}>
